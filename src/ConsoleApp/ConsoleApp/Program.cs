...
// bucles in C# can be done using for, while, do-while, and foreach loops.
// for is used for iterating a specific number of times or through a range of values.
Console.WriteLine("For loop example:");
for (int i = 0; i < 5; i++)
{
    Console.WriteLine($"Iteration {i}"); // Prints: Iteration 0, Iteration 1, ..., Iteration 4
}
// while is used to iterate as long as a condition is true, and do-while is similar but guarantees at least one iteration.
// while loop example using numbers array
int index = 0;
...
// do-while loop example using numbers array
index = 0;
...
{
    Console.WriteLine(number); // Prints each number in the numbers array
}

// conditional statements in C# can be done using if, else if, and else statements.
// if is used to check a condition and execute code if the condition is true.
if (sale.Total > 50.0m)
{
    Console.WriteLine("Sale is greater than 50.0"); // This will print because sale.Total is 100.0
}
...
// logic operators in C# include && (and), || (or), ! (not), and == (equals).
// These operators are used to combine or negate conditions in conditional statements.

// && (and) checks if both conditions are true.
if (sale.Total > 50.0m && sale.Total < 200.0m)
{
    Console.WriteLine("Sale is between 50.0 and 200.0"); // This will print because sale.Total is 100.0
}
...
if (!(sale.Total < 50.0m))
{
    Console.WriteLine("Sale is not less than 50.0"); // This will print because sale.Total is 100.0
}

// == (equals) check if values are the same
if (sale.Total == 100) Console.WriteLine("Sale is 100");